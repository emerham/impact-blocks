...
<div class="impact-tools">
  <div class="row-fluid">
    ...
    <div class="toolbox">
      <a href="<?php print $var['url'];?>"><i class="fa <?php print $var['icon'];?>"></i>
        <p><?php print $var['title'];?></p>
      </a>
      </div>
    <?php
    };
  ...
  <div class="row-fluid">
    <a href="<?php print variable_get('last_button_link')?>" class="beyond">
      <i class="fa fa-globe" style="font-size:18px;"></i> <?php print variable_get('last_button_text')?></a>
  </div>
</div>
</div>
